...
Group:          kernel
Source0:        https://cdn.kernel.org/pub/linux/kernel/v5.x/linux-5.15.161.tar.xz
Source1:        config
Source2:        cmdline

%define ktarget  lts2021
...
Requires: linux-lts2021-license = %{version}-%{release}
...
%package license
Summary: license components for the linux-lts2021 package.
Group: Default

%description license
license components for the linux-lts2021 package.
...
Summary:        The Linux kernel
Group:          kernel
Requires:       linux-lts2021 = %{version}-%{release}
Requires:       linux-lts2021-extra = %{version}-%{release}
Requires:       linux-lts2021-license = %{version}-%{release}
